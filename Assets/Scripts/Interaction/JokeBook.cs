...
public class JokeBook : InteractionObjectBase
{
    public override void Effect()
    {
        ...
        {
            PhotonNetwork.Instantiate("JokeBook", new Vector3(Xposition(this.transform.position.x), YPosition(this.transform.position.y), -116.95f), Quaternion.identity);
        }
    }
    ...
    {
        base.Update();
        if (GameObject.Find("JokeBook(Clone)"))
        {
